...
from drop_agent.sub_agents.search.tools.search_tool import SearchEnhancementTool
...
When you receive a video idea, you MUST use the `SearchEnhancementTool` to get trending information.
