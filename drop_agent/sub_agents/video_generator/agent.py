...
from ...custom_tools import submit_veo_generation_job, get_video_job_status
...
# The agent communicates directly with Vertex AI and tracks jobs in Firebase.

# --- Agent Definition ---
video_generator_agent = Agent(
    name="video_generator_agent",
    model="gemini-2.0-flash",
    description="Specialist agent for submitting finalized video scripts to Google's Veo 3 video generation engine with advanced audio and visual capabilities.",
    instruction=VIDEO_GENERATOR_PROMPT,
    tools=[submit_veo_generation_job, get_video_job_status],
